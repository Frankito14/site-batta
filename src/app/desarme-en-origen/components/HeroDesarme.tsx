...
import ImageDesarme from "@assets/images/servicios/desarme.webp";
import Image from "next/image";

const DATA = {
    title: "Desarme en Origen",
    subtitle: "Desmontaje profesional de tus muebles.",
    description: "Si contratas nuestro servicio intermedio o full, nuestros operarios se encargarán del desarme de tus muebles en el lugar de origen, facilitando tu mudanza. Garantizamos el máximo cuidado.",
    items: [
    ...
    requirement: "Para garantizar un servicio seguro y exitoso, los muebles deben estar en buen estado, contar con sus tornillos originales y no deben haber sido fijados con cola vinílica (pegamento)."
}

export default function HeroDesarme() {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="flex flex-col justify-center space-y-6">
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start space-x-4">
                            ...
                            <div>
                                <h3 className="text-amber-800 font-bold mb-1 text-sm">Requisito indispensable</h3>
                    ...
                    <div className="relative w-full aspect-[4/3] flex items-center justify-center mt-8 lg:mt-0">
                        <div className="relative z-10 w-full h-full p-2 md:p-4 flex items-center justify-center overflow-hidden">
                            <Image
                                src={ImageDesarme}
                                alt="Desarme de muebles en origen"
